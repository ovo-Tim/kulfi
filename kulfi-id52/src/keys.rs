...
/// Public key that uses ID52 encoding (BASE32_DNSSEC, 52 characters)
///
/// # Examples
///
/// ```
/// use kulfi_id52::PublicKey;
/// use std::str::FromStr;
///
...
/// Secret key that uses hexadecimal encoding for display
///
/// # Examples
///
/// ```
...
///
/// ```
/// use kulfi_id52::{SecretKey, Signature};
///
/// let secret_key = SecretKey::generate();
